...
import { INSCRIPTION_LEGAL_VERSION } from "@/lib/inscripcion-legal";
...
/**
 * PDF sin pdfkit (evita cuelgues / bundling pesado en `next build`).
 */
export function buildConsentPdfBuffer(row: JugadorConsentPdfRow): Buffer {
  ...
  const pairs: [string, string][] = [
    ...
    ["Menor de edad", row.es_menor ? "Si" : "No"],
    ...
    ["Version texto legal", row.consentimiento_legal_version ?? INSCRIPTION_LEGAL_VERSION],
